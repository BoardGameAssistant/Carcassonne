        ...
        for i in range(min_y, max_y+1):
            for j in range(min_x, max_x+1):
                if self.game_state.board[i][j] is not None:
                    ...
                    img[coord_y*64:(coord_y+1)*tile_size, coord_x*tile_size:(coord_x+1)*tile_size] = tile_img

        return img

    def get_possible_positions(self, new_tile):
        ...
        for i in range(min_y, max_y+1):
            for j in range(min_x, max_x+1):
                if self.game_state.board[i][j] is not None:
                    ...
                    tile_img = Image.open(tile.image)
                    tile_img = np.asarray(tile_img.resize((tile_size, tile_size)))
                    img[coord_y*tile_size:(coord_y+1)*tile_size, coord_x*tile_size:(coord_x+1)*tile_size] = tile_img
        ...
        for tile_position in positions:
            ...
            img[coord_y*tile_size:(coord_y+1)*tile_size, coord_x*tile_size:(coord_x+1)*tile_size] = np.array([173,255,47])
